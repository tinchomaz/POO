...
public class Matematica {
    ...
    public  double devolverMayor(){
        ...
        return ( Math.max( this.getNum1() ,  this.getNum2() )); 
    }
     public  double devolverMenor(){
        
        //return ( Math.max( this.num1, this.num2 )); 
        return ( Math.min( this.getNum1() ,  this.getNum2() )); 
    }
    
    public double  calcularPotencia(){
         
         return (  Math.pow( Math.round(Math.max( this.getNum1() ,  this.getNum2() )) , 
                             Math.round(Math.min( this.getNum1() ,  this.getNum2() )) 
                            )  
                ) ; 
    }
